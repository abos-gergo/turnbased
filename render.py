...
def renderTiles(offset, Display, player, tile_in_focus, Button, collide):
    ...
    Display.blit(tiles.TileTypes.outline.convert_alpha(), ((tile_in_focus.x) * 32 - (tile_in_focus.y) * 32 + offset[0], (tile_in_focus.x) * 16 + (tile_in_focus.y) * 16 - tile_in_focus.z * 32 + offset[1] - tile_in_focus.anchor_y))
